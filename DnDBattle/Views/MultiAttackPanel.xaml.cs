...
namespace DnDBattle.Views
{
    public partial class MultiAttackPanel : UserControl
    {
        ...
        private List<Models.Action> _multiattackActions = new List<Models.Action>();
        ...
        private bool IsLikelyAttack(Models.Action action)
        {
        ...
        private Button CreateAttackButton(Models.Action action)
        {
            var btn = new Button
            {
            ...
            btn.Click += (s, e) =>
            {
                if (s is Button b && b.Tag is Models.Action a)
                {
        ...
        private (bool hit, bool crit, int damage, string message) RollAttack(Models.Action action)
        {
