...
namespace DnDBattle.Services.Encounters
{
    public static class EncounterService
    {
        ...
        private static List<object> MapActionsToObjects(List<Models.Combat.Action> lst)
        {
        ...
        private static List<Models.Combat.Action> MapObjectsToActions(List<object> objs)
        {
            var outList = new List<Models.Combat.Action>();
            ...
            try
            {
                ...
                foreach (var o in objs)
                {
                    try
                    {
                        ...
                        var a = JsonSerializer.Deserialize<Models.Combat.Action>(json, opts);
