...
namespace DnDBattle.Services
{
    ...
    {
        public static void ExportTokensToJson(string filePath, IEnumerable<Models.Token> tokens)
        {
        ...
        private static List<object> MapAttackActionList(List<Models.Action> actions)
        {
