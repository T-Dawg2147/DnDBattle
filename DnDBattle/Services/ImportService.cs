...
namespace DnDBattle.Services
{
    public static class ImportService
    {
        ...
        private static void MapActionArrayToList(JsonElement el, string propName, List<Models.Action> target)
        {
        ...
        private static Models.Action MapJsonElementToAction(JsonElement el)
        {
            try
            {
        ...
        /*private static DnDBattle.Models.Action MapJsonElementToAttackAction(JsonElement el)
        {
            string error = "Error";
            try
            {
                var action = new DnDBattle.Models.Action();
